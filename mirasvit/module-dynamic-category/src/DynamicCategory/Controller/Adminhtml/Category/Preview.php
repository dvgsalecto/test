...
use Mirasvit\DynamicCategory\Service\CategoryService as DynamicCategoryService;
...
class Preview extends Action implements HttpPostActionInterface
{
    ...
    private $dynamicCategoryService;
    ...
    public function __construct(
        ...
        DynamicCategoryService $dynamicCategoryService,
    ...
    public function execute(): Raw
    {
        ...
        $ruleData = $this->dynamicCategoryService->prepareConditions($ruleData);
